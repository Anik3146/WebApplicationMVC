...
namespace WebApplicationMVC.Controllers
{
    ...
    {
        private readonly Student_infoContext _context;

        public StudentsController(Student_infoContext context)
        {
            _context = context;
        }
        ...
        {
            var student_infoContext = _context.Students.Include(s => s.Class);
            return View(await student_infoContext.ToListAsync());
        }
        ...
        public async Task<IActionResult> DeleteConfirmed(Guid id)
        {
            ...
            {
                return Problem("Entity set 'Student_infoContext.Students'  is null.");
            }
            var student = await _context.Students.FindAsync(id);
            if (student != null)
            {
